...
void sym_par_finished(tap_dance_state_t *state, void *user_data);
void sym_par_reset(tap_dance_state_t *state, void *user_data);
void sym_bra_finished(tap_dance_state_t *state, void *user_data);
void sym_bra_reset(tap_dance_state_t *state, void *user_data);
void sym_cur_finished(tap_dance_state_t *state, void *user_data);
void sym_cur_reset(tap_dance_state_t *state, void *user_data);
void sym_com_finished(tap_dance_state_t *state, void *user_data);
void sym_com_reset(tap_dance_state_t *state, void *user_data);
void sym_que_finished(tap_dance_state_t *state, void *user_data);
void sym_que_reset(tap_dance_state_t *state, void *user_data);
...
[QWERTY] = LAYOUT_ansi_87( 
     ...
     LT(EXTEND, KC_BSPC),     LGUI_T(KC_A),   LALT_T(KC_S),  LCTL_T(KC_D),   LSFT_T(KC_F),   KC_G,            KC_RBRC,                 KC_H,          RSFT_T(KC_J),   RCTL_T(KC_K),    LALT_T(KC_L),           RGUI_T(KC_SCLN),                    KC_ENT,                 
...
[GAMING_FN] = LAYOUT_ansi_87( 
     KC_TRNS,                 KC_BRID,        KC_BRIU,       KC_TRNS,        KC_TRNS,        RGB_VAD,         RGB_VAI,                 KC_MPRV,       KC_MPLY,        KC_MNXT,         KC_MUTE,                KC_VOLD,             KC_VOLU,                   KC_PSCR,      KC_TRNS,         RGB_TOG,
...
[GAMING] = LAYOUT_ansi_87( 
     ...
     KC_LSFT,                                 KC_Z,          KC_X,           KC_C,           KC_V,            KC_B,                    KC_SLSH,       KC_N,           KC_M,            KC_COMM,                KC_DOT,                             KC_RSFT,                  KC_UP,    
     KC_LCTL,                 KC_LGUI,        KC_LALT,                                                        KC_SPC,                                                                  MO(GAMING_FN),          KC_RALT,             KC_RGUI,       KC_RCTL,    KC_LEFT,      KC_DOWN,         KC_RGHT),
[EXTEND] = LAYOUT_ansi_87(      
     KC_ESC,                  KC_BRID,        KC_BRIU,       KC_NO,          KC_NO,          RGB_VAD,         RGB_VAI,                 KC_MPRV,       KC_MPLY,        KC_MNXT,         KC_MUTE,                KC_VOLD,             KC_VOLU,                   RGB_MOD,      RGB_RMOD,        RGB_TOG,
     ...
     KC_BSPC,                 KC_LGUI,        KC_LALT,       KC_LCTL,        KC_LSFT,        KC_NO,           KC_NO,                   KC_PGDN,       KC_LEFT,        KC_DOWN,         KC_RIGHT,               KC_BSPC,                            KC_ENT,                 
...
[SYMBOLS] = LAYOUT_ansi_87( 
     MO(QK),                  KC_NO,          KC_NO,         KC_NO,          KC_NO,          KC_NO,           KC_NO,                   KC_NO,         KC_NO,          KC_NO,           KC_NO,                  KC_NO,               KC_NO,                     KC_NO,        KC_NO,           KC_NO,
...
[QK] = LAYOUT_ansi_87( 
     KC_TRNS,                 QK_BOOT,        KC_NO,         KC_NO,          KC_NO,          KC_NO,           KC_NO,                   KC_NO,         KC_NO,          KC_NO,           KC_NO,                  KC_NO,               KC_NO,                     KC_NO,        KC_NO,           KC_NO,
